...
class TraScuMainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		bSizer3.Add( self.m_exe_picker, 1, wx.ALL|wx.EXPAND, 5 )

		self.m_chk_steam = wx.CheckBox( self, wx.ID_ANY, u"Launch via Steam", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer3.Add( self.m_chk_steam, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )


		bottom_info_sizer.Add( bSizer3, 1, wx.EXPAND, 5 )
